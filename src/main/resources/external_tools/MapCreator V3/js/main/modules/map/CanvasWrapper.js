...
export class CanvasWrapper{
    ...
    init_canvas_logic(){
        ...
        //maintain 'clicked' flag
        this.canvas.addEventListener("mouseup", (e)=> this.clicked = false);
        this.canvas.addEventListener("mousedown", (e)=> this.clicked = true);
    }
    ...
    canvas_click(e){
        ...
        //debug
        /*if(tile_info == null) console.log(`tile [${coords.x}, ${coords.y}] doesnt exist`);
        else console.log(`clicked tile [${coords.x}, ${coords.y}]`);*/

        this.tile_clicked = tile_info;
        
        this.test(tile_info, "green");
    }
    ...
    canvas_hover(e){
        ...
        //debug
        /*if(tile_info == null) console.log(`tile [${coords.x}, ${coords.y}] doesnt exist`);
        else console.log(`hovering tile [${coords.x}, ${coords.y}]`);*/


        this.tile_under_mouse = tile_info;

        this.test(tile_info, "blue");
    }
    ...
    get_tile_info_from_event(e){
        ...
        //transform hover coords in pixeld to logical map-indexed coords
    ...
    test(tinfo, color){
        ...
        let {x, y} = tinfo.screen_pos;
        this.ctx.fillRect(x, y, this.owner.tileRenderSize, this.owner.tileRenderSize);
    }
